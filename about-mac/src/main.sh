...
JSON_String+="{\"title\":\"${arrIN[9]} ${arrIN[4]}\",\"subtitle\":\"MacOS System Version\",\"icon\":{\"path\":\"./icons/mac.png\"},\"arg\":\"${arrIN[9]} ${arrIN[4]}\",\"uid\":\"mac_os_system_version\",\"text\":{\"copy\":\"${arrIN[9]} ${arrIN[4]}\",\"largetype\":\"${arrIN[9]} ${arrIN[4]}\"},\"match\":\"os ${arrIN[9]} ${arrIN[4]} \"},"
...
JSON_String+="{\"title\":\"Display Resolution\",\"subtitle\":\"${displayResolution}\",\"icon\":{\"path\":\"./icons/display-resolution.png\"},\"arg\":\"${displayResolution}\",\"uid\":\"display_resolution\",\"text\":{\"copy\":\"${displayResolution}\",\"largetype\":\"${displayResolution}\"}}"
JSON_String+="]}"
echo $JSON_String
